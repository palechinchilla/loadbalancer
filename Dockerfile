...
RUN uv pip install fastapi "uvicorn[standard]" requests websockets boto3 pydantic tqdm

# Add application code and scripts
ADD src/start.sh src/network_volume.py app.py s3_upload.py test_input.json ./
...
RUN wget -q -O models/text_encoders/qwen_3_4b.safetensors https://huggingface.co/Comfy-Org/z_image_turbo/resolve/main/split_files/text_encoders/qwen_3_4b.safetensors && \
